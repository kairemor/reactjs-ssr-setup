...
const collectTranslationSourceFiles = async () => {
    ...
    const responses = await Promise.all(translationFiles.map((file) => uploadTranslations(
        file)));
    console.log(responses);
};

const uploadTranslations = async (filename) => {
...
export const writeFiles = async (data, targetFolder) => {
