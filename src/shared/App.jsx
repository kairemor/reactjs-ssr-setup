...
const App = () => {
    ...
    return (
        ...
        <div className={css.wrapper}>
            <Helmet
                defaultTitle="React SSR Starter – JavaScript Edition"
                titleTemplate="%s – React SSR Starter – JavaScript Edition"
                link={[{ rel: 'icon', type: 'image/png', href: favicon }]}
            />
            <h1>
                <ReactLogo className={css.reactLogo} /> React + Express – SSR Starter – JavaScript
                Edition
            </h1>
            <Switch>
